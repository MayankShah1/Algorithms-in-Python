class Progression:
    ...
    def __getitem__(self, j):
        """Returns the jth item from the series"""
        result = None
        for i in range(j):
    ...
    def print_value(self,j):
        """Prints the jth item of the series"""
        print(str(j)+'th value : ',self.__getitem__(j))
...
if __name__ == "__main__":
    ...
    FibonacciProgression(2,2).print_value(8)
